...
const Container = styled.div`
  ${({
    ...
    ${bgColor
      ...
      : css``}
    z-index: ${zIndex};
    ${size && size !== true ? css`padding-bottom: ${size};` : ""}
    ${mq.sm} {
      ${sizeSM && sizeSM !== true ? css`padding-bottom: ${sizeSM};` : ""}
    }
    ${mq.md} {
      ${sizeMD && sizeMD !== true ? css`padding-bottom: ${sizeMD};` : ""}
    }
    ${mq.lg} {
      ${sizeLG && sizeLG !== true ? css`padding-bottom: ${sizeLG};` : ""}
    }
    ${mq.xl} {
      ${sizeXL && sizeXL !== true ? css`padding-bottom: ${sizeXL};` : ""}
    }
    ${height && height !== true ? css`height: ${height};` : ""}
    ${mq.sm} {
      ${heightSM && heightSM !== true ? css`height: ${heightSM};` : ""}
    }
    ${mq.md} {
      ${heightMD && heightMD !== true ? css`height: ${heightMD};` : ""}
    }
    ${mq.lg} {
      ${heightLG && heightLG !== true ? css`height: ${heightLG};` : ""}
    }
    ${mq.xl} {
      ${heightXL && heightXL !== true ? css`height: ${heightXL};` : ""}
    }
  `}
`;
