...
const ServiciosEstudiantilesActividades = () => {
  ...
  const title = "Grupos y clubes estudiantiles",
    actividadesExtracurriculares = [
      ...
      },
      {
        ...
        copy: "Desarrolla acciones encaminadas a fomentar valores, permitiendo a los jóvenes descubrir habilidades de crecimiento personal, fomentar la solidaridad y el respeto, comprometiéndose con Jesucristo y su mensaje.",
        cta: null,
      ...
      // },
      {
        ...
        copy: "Tiene como misión el contribuir con el fortalecimiento de la enseñanza- aprendizaje de las ciencias en la República Dominicana a través del desarrollo intelectual, científico, cultural y social de los profesores de ciencias de la naturaleza en el país.",
        cta: null,
      ...
      // },
      {
        ...
        copy: "Es un grupo formado por estudiantes apasionados por la fotografía, con el objetivo de aprender más acerca del mundo de este fantástico arte y poder desarrollar sus habilidades sin importar que equipo tenga.",
        cta: null,
        image: images["servicios-estudiantiles"].cine_foro,
        position: "50% 50%",
      },
      {
        title: "CINECLUB",
        copy: "Pretende vincular experiencias compartidas a través de un diálogo con el cine, descubrir, observar y debatir de forma crítica la representación cinematográfica. Además de ofrecer un espacio dinámico y creativo que más allá del rol del espectador pasivo, potencie una reflexión colectiva entre compañeros.",
        cta: null,
        image: images["servicios-estudiantiles"].cine_foro,
        position: "50% 50%",
      },
  ...
  return actividadesExtracurriculares ? (
    <Section spaceBottomNone id="section_1" fluid>
