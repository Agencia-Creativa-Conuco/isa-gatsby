            ...
            <Content>
              <Copy>
                <ul css={listStyles}>
                  ...
                  <li>
                    Deberes y derechos de los contribuyentes y ciudadanos.
                  </li>
                  <li>
                    Uso de los servicios en línea del portal web y oficina
                    virtual de Impuestos Internos.
                  </li>
                  <li>
                    Inscripción y actualización del Registro Nacional de
                    Contribuyentes (RNC).
                  </li>
                  <li>
                    Registro del Régimen Simplificado de Tributación (RST).
                  </li>
                  ...
                  <li>
                    Selección del único agente de retención para asalariados.
                  </li>
